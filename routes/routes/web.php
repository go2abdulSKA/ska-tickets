...
// Route::get('/test', \App\Livewire\Test\TestList::class)->name('test');

Route::get('/', function () {
    return redirect()->route('login');
});

Route::get('/test', \App\Livewire\Users\Index::class);
...
Route::middleware([
    ...
    Route::prefix('masters')->name('masters.')->group(function () {
        ...
        // UOM - Using Livewire Component
        Route::get('/uom', UOMList::class)->name('uom');
    });
