<div class="offcanvas offcanvas-end overflow-hidden" tabindex="-1" id="theme-settings-offcanvas">
    <div class="d-flex justify-content-between text-bg-primary gap-2 p-3"
        style="background-image: url({{ asset('backend/assets/images/user-bg-pattern.png);') }}">

        <div>
            <h5 class="mb-1 fw-bold text-white text-uppercase">
                {{ config('app.name') }} Customizer
            </h5>
            <p class="text-white text-opacity-75 fst-italic fw-medium mb-0">
                Easily configure layout, styles, and preferences for {{ config('app.name') }}.
            </p>
        </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio shadow">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-default">
                            <img src="{{ asset('backend/assets/images/layouts/themes/theme-default.png') }}"
                ...
                <div class="col-6">
                    <div class="form-check card-radio shadow">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-material">
                            <img src="{{ asset('backend/assets/images/layouts/themes/theme-material.png') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio shadow">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-modern">
                            <img src="{{ asset('backend/assets/images/layouts/themes/theme-modern.png') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio shadow">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-saas">
                            <img src="{{ asset('backend/assets/images/layouts/themes/theme-saas.png') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio shadow">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-flat">
                            <img src="{{ asset('backend/assets/images/layouts/themes/theme-flat.png') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio shadow">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-minimal">
                            <img src="{{ asset('backend/assets/images/layouts/themes/theme-minimal.png') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="layout-color-light">
                            <img src="{{ asset('backend/assets/images/layouts/light.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="layout-color-dark">
                            <img src="{{ asset('backend/assets/images/layouts/dark.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="layout-color-system">
                            <img src="{{ asset('backend/assets/images/layouts/system.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="topbar-color-light">
                            <img src="{{ asset('backend/assets/images/layouts/topbar-light.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                    <h5 class="text-center text-muted mt-2 mb-0">Light</h5>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="topbar-color-dark">
                            <img src="{{ asset('backend/assets/images/layouts/topbar-dark.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="topbar-color-gray">
                            <img src="{{ asset('backend/assets/images/layouts/topbar-gray.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="topbar-color-gradient">
                            <img src="{{ asset('backend/assets/images/layouts/topbar-gradient.svg') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-dark">
                            <img src="{{ asset('backend/assets/images/layouts/side-dark.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                    <h5 class="fs-sm text-center text-muted mt-2 mb-0">Dark</h5>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-gray">
                            <img src="{{ asset('backend/assets/images/layouts/side-gray.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                    <h5 class="fs-sm text-center text-muted mt-2 mb-0">Gray</h5>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-gradient">
                            <img src="{{ asset('backend/assets/images/layouts/side-gradient.svg') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                    <h5 class="fs-sm text-center text-muted mt-2 mb-0">Gradient</h5>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-image">
                            <img src="{{ asset('backend/assets/images/layouts/side-image.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-size-compact">
                            <img src="{{ asset('backend/assets/images/layouts/sidebar-compact.svg') }}"
                                alt="layout-img" class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-size-small">
                            <img src="{{ asset('backend/assets/images/layouts/sidebar-sm.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-size-offcanvas">
                            <img src="{{ asset('backend/assets/images/layouts/sidebar-full.svg') }}" alt="layout-img"
                                class="img-fluid" />
                        </label>
                    </div>
    ...
    <div class="offcanvas-footer border-top p-3 text-center">
        <div class="row">
            <div class="col-6">
                <button type="button" class="btn btn-light fw-semibold py-2 w-100" id="reset-layout">
                    Reset
                </button>
            </div>
            {{-- <div class="col-6">
