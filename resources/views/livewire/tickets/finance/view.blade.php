...
<div>
    <div class="offcanvas offcanvas-end show" style="visibility: visible; width: 600px;" tabindex="-1">
        ...
        <div class="p-0 offcanvas-body">
            ...
            <div class="p-3 bg-light border-bottom">
                <div class="gap-2 d-grid">
                    ...
                    {{-- Duplicate Button --}}
                    <button type="button" wire:click="duplicate" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="p-3">
                ...
                <div class="mb-4 row g-2">
                    ...
                    <div class="col-6">
                        ...
                        <span
                            class="badge badge-soft-{{ $ticket->client_type->value === 'client' ? 'primary' : 'info' }}">
                ...
                @if ($ticket->attachments->count() > 0)
                    ...
                    <div class="mb-4 list-group">
                        @foreach ($ticket->attachments as $attachment)
                            <a href="javascript:void(0);" wire:click="downloadAttachment({{ $attachment->id }})"
                        ...
                        @foreach ($ticket->statusHistory as $history)
                            <div class="mb-3 timeline-item">
                                <div class="d-flex">
                                    <div class="me-3">
                                        <div
                                            class="timeline-icon bg-{{ $history->to_status === 'posted' ? 'success' : ($history->to_status === 'cancelled' ? 'danger' : 'warning') }}">
                                            <i
                                                class="{{ \App\Enums\TicketStatus::from($history->to_status)->iconClass() }} text-white"></i>
                                        </div>
                                    </div>
