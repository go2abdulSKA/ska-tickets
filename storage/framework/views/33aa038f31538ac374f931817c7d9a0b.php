...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.page-header','data' => ['title' => 'Service Types','page' => 'Masters','subpage' => 'Service Types']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Service Types','page' => 'Masters','subpage' => 'Service Types']); ?>
...
<?php endif; ?>
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table mb-0 table-custom table-centered table-select table-hover w-100">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    
                                    <td class="ps-3">
                                        <input wire:model.live="selectedItems" value="<?php echo e($serviceType->id); ?>"
                                            class="mt-0 form-check-input form-check-input-light fs-14" type="checkbox">
                                    </td>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" wire:click="view(<?php echo e($serviceType->id); ?>)">
                                            <span class="badge badge-soft-primary fs-xs"><?php echo e($serviceType->service_type); ?></span>
                                        </a>
                                    ...
                                    <td>
                                        <span class="badge badge-soft-secondary fs-xxs">
                                            <?php echo e($serviceType->department->name ?? 'N/A'); ?>
                                    ...
                                    <td>
                                        <span class="text-muted"><?php echo e(Str::limit($serviceType->description ?? 'N/A', 50)); ?></span>
                                    </td>

                                    
                                    <td>
                                        <span class="badge badge-soft-info fs-xxs">
                                            <?php echo e($serviceType->tickets_count); ?> tickets
                                        </span>
                                    </td>

                                    
                                    <td>
                                        <?php echo e($serviceType->created_at->format('d M, Y')); ?>

                                        <small class="text-muted"><?php echo e($serviceType->created_at->format('h:i A')); ?></small>
                                    </td>

                                    
                                    <td>
                                        <span
                                            class="badge badge-soft-<?php echo e($serviceType->is_active ? 'success' : 'danger'); ?> fs-xxs">
                                            <?php echo e($serviceType->is_active ? 'Active' : 'Inactive'); ?>
                                    ...
                                    <td>
                                        <div class="gap-1 d-flex justify-content-center">
                                            <button wire:click="view(<?php echo e($serviceType->id); ?>)"
                                                class="btn btn-default btn-icon btn-sm rounded-circle"
                                                title="View Details">
                                                <i class="ti ti-eye fs-lg"></i>
                                            </button>
                                            <button wire:click="edit(<?php echo e($serviceType->id); ?>)"
                                                class="btn btn-default btn-icon btn-sm rounded-circle" title="Edit">
                                                <i class="ti ti-edit fs-lg"></i>
                                            </button>
                                            <button wire:click="confirmDelete(<?php echo e($serviceType->id); ?>)"
                ...
                <div class="border-0 card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            Showing
                            <span class="fw-semibold"><?php echo e($serviceTypes->firstItem() ?? 0); ?></span> to
                            <span class="fw-semibold"><?php echo e($serviceTypes->lastItem() ?? 0); ?></span> of
                            <span class="fw-semibold"><?php echo e($serviceTypes->total()); ?></span> Service Types
                        </div>
                        <div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showModal): ?>
        <?php echo $__env->make('livewire.masters.service-types.add-service-type', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

    <!--[if BLOCK]><![endif]--><?php if($showOffcanvas && $viewServiceType): ?>
        <?php echo $__env->make('livewire.masters.service-types.view-service-type', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

    <!--[if BLOCK]><![endif]--><?php if($showDeleteModal): ?>
        <?php echo $__env->make('livewire.masters.service-types.delete-service-type', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\ska-tickets\resources\views/livewire/masters/service-types/index.blade.php ENDPATH**/ ?>