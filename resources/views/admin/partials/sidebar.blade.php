        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarMasters"
                    ...
                    aria-controls="sidebarMasters" {{-- {{ request()->routeIs('masters.*') ? '' : 'collapsed' }}"> --}} class="side-nav-link"
                ...
                <div class="collapse {{ request()->routeIs('masters.*') ? 'show' : '' }}" id="sidebarMasters">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="{{ route('masters.department') }}" {{-- {{ request()->routeIs('masters.department') ? 'active' : '' }}"> --}} class="side-nav-link"
                                wire:current="active">
                        ...
                        <li class="side-nav-item">
                            <a href="{{ route('masters.user') }}" class="side-nav-link" wire:current="active">
                                {{-- {{ request()->routeIs('masters.user') ? 'active' : '' }}"> --}}
                                <i class="ti ti-users"></i>
                                <span class="menu-text"> Users </span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('masters.client') }}" class="side-nav-link" wire:current="active">
                                {{-- {{ request()->routeIs('masters.client') ? 'active' : '' }}"> --}}
                                <i class="ti ti-users"></i>
                                <span class="menu-text"> Clients </span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="{{ route('masters.cost-centers') }}" {{-- {{ request()->routeIs('masters.cost-centers.*') ? 'active' : '' }}"> --}} class="side-nav-link"
                                wire:current="active">
                        ...
                        <li class="side-nav-item">
                            <a href="{{ route('masters.service-type') }}" {{-- {{ request()->routeIs('masters.service-type.*') ? 'active' : '' }}"> --}}
                        ...
                        <li class="side-nav-item">
                            <a href="{{ route('masters.uom-list') }}" {{-- {{ request()->routeIs('masters.uom-list.*') ? 'active' : '' }}"> --}} class="side-nav-link"
                                wire:current="active">
