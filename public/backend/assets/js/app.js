class App {
    init() {
        this.initComponents(), this.initPreloader(), this.initPortletCard(), this.initMultiDropdown(), this.initFormValidation(), this.initCounter(), this.initCodePreview(), this.initToggle(), this.initDismissible(), this.initLeftSidebar(), this.initTopbarMenu()
    }
    initComponents() {
        "function" == typeof lucide.createIcons && lucide.createIcons(), document.querySelectorAll('[data-bs-toggle="popover"]').forEach(e => {
    ...
    initPortletCard() {
        document.querySelectorAll('[data-action="card-close"]').forEach(a => {
            a.addEventListener("click", e => {
                ...
                t && (t.style.transition = "opacity 0.3s ease", t.style.opacity = "0", setTimeout(() => t.remove(), 300))
            })
            ...
            o.addEventListener("click", e => {
                ...
                var e = o.closest(".card"),
                    t = o.querySelector("i"),
                    e = (e.querySelectorAll(".card-body, .card-footer"), o.closest(".card"));
                let a = e.querySelector(".card-body");
                a.style.transition = "height, margin, 0.35s ease-in-out";
                var i = a.scrollHeight;
                e.classList.contains("card-collapsed") ? (a.style.height = "0", a.style.overflow = "hidden", a.offsetHeight, e.classList.remove("card-collapsed"), a.style.height = i + "px", setTimeout(function() {
                    a.style.overflow = "visible", a.style.height = "auto"
                }, 350)) : (a.style.height = i + "px", a.style.overflow = "hidden", a.offsetHeight, e.classList.add("card-collapsed"), a.style.height = "0"), t && (t.classList.toggle("ti-chevron-up"), t.classList.toggle("ti-chevron-down"))
            })
            ...
            i.addEventListener("click", e => {
                ...
                a || ((a = document.createElement("div")).className = "card-overlay", (t = document.createElement("div")).className = "spinner-border text-primary", a.appendChild(t), e.appendChild(a)), a.style.display = "flex", setTimeout(() => {
            ...
            e.forEach(s => {
                if (s.isIntersecting) {
                    let e = s.target,
                        ...
                        a = (t = parseFloat(t), 0),
                        i, o = (i = Number.isInteger(t) ? Math.floor(t / 25) : t / 25, () => {
                            a < t ? ((a += i) > t && (a = t), e.innerText = r(a), requestAnimationFrame(o)) : e.innerText = r(t)
                        });
                ...
                e = (o.forEach(e => {
                    e.addEventListener("show.bs.collapse", e => {
                        let t = e.target,
                            a = [],
                            i = t.parentElement;
                        for (; i && i !== s;) i.classList.contains("collapse") && a.push(i), i = i.parentElement;
                        o.forEach(e => {
            ...
            s.querySelectorAll("a").forEach(t => {
                if (t.href === e) {
                    ...
                    for (; e && e !== s;) {
                        ...
                        e = a ? (new bootstrap.Collapse(a, {
                            toggle: !1
                        }).show(), (a = a.closest("li")) && a.classList.add("active"), a) : e.parentElement
                    }
                }
            }), setTimeout(() => {
                ...
                if (e && t) {
                    ...
                    if (100 < e) {
                        ...
                        ! function e() {
                            var t, a, i;
                            r += 20, n.scrollTop = (t = r, a = o, i = s, (t /= l / 2) < 1 ? i / 2 * t * t + a : -i / 2 * (--t * (t - 2) - 1) + a), r < l && setTimeout(e, 20)
                        }()
                    }
                }
            }, 200)
...
class LayoutCustomizer {
    ...
    init() {
        this.initConfig(), this.initSwitchListener(), this.monochromeMode(), this.initfullScreenListener(), this.initWindowSize(), this._adjustLayout(), this.setSwitchFromConfig(), this.openCustomizer()
    }
    initConfig() {
    ...
    monochromeMode() {
        ...
        e && e.addEventListener("click", () => {
            this.config.monochrome = !this.config.monochrome, this.config.monochrome ? this.html.classList.add("monochrome") : this.html.classList.remove("monochrome"), this.setSwitchFromConfig()
        })
    }
    ...
    applyPreset(e) {
        e = skinPresets?.[e];
        e && (e.theme && (this.config.theme = e.theme, this.html.setAttribute("data-bs-theme", e.theme)), e.topbar && (this.config.topbar.color = e.topbar, this.html.setAttribute("data-topbar-color", e.topbar)), e.menu && (this.config.menu.color = e.menu, this.html.setAttribute("data-menu-color", e.menu)), e.sidenav?.size && (this.config.sidenav.size = e.sidenav.size, this.html.setAttribute("data-sidenav-size", e.sidenav.size)), void 0 !== e.sidenav?.user) && (this.config.sidenav.user = e.sidenav.user, e.sidenav.user ? this.html.setAttribute("data-sidenav-user", "true") : this.html.removeAttribute("data-sidenav-user"))
    }
    changeSkin(e) {
    ...
    resetTheme() {
        this.config = JSON.parse(JSON.stringify(window.defaultConfig)), this.changeSkin(this.config.skin), this.changeMenuColor(this.config.menu.color), this.changeLeftbarSize(this.config.sidenav.size), this.changeTheme(this.config.theme), this.changeLayoutPosition(this.config.layout.position), this.changeTopbarColor(this.config.topbar.color), this.changeSidebarUser(this.config.sidenav.user), this._adjustLayout()
    }
    setSwitchFromConfig() {
        var e = this.config;
        sessionStorage.setItem("__UBOLD_CONFIG__", JSON.stringify(e)), document.querySelectorAll("#theme-settings-offcanvas input[type=radio]").forEach(e => e.checked = !1);
        ((e, t) => {
            e = document.querySelector(e);
            e && (e.checked = t)
    ...
    initSwitchListener() {
        var e = (e, t) => {
            ...
            e = (e('input[name="data-skin"]', e => this.changeSkin(e.value)), e('input[name="data-bs-theme"]', e => this.changeTheme(e.value)), e('input[name="data-menu-color"]', e => this.changeMenuColor(e.value)), e('input[name="data-sidenav-size"]', e => this.changeLeftbarSize(e.value)), e('input[name="data-layout-position"]', e => this.changeLayoutPosition(e.value)), e('input[name="data-topbar-color"]', e => this.changeTopbarColor(e.value)), e('input[name="sidebar-user"]', e => this.changeSidebarUser(e.checked)), document.getElementById("light-dark-mode")),
    ...
    _toggleSidebar() {
        ...
        "offcanvas" === e ? this.showBackdrop() : "compact" === t ? this.changeLeftbarSize("condensed" === e ? "compact" : "condensed", !1) : this.changeLeftbarSize("condensed" === e ? "default" : "condensed", !0), this.html.classList.toggle("sidebar-enable")
    }
    showBackdrop() {
        var e = document.createElement("div");
        e.id = "custom-backdrop", e.className = "offcanvas-backdrop fade show", document.body.appendChild(e), document.body.style.overflow = "hidden", 767 < window.innerWidth && (document.body.style.paddingRight = "15px"), e.addEventListener("click", () => {
            this.html.classList.remove("sidebar-enable"), this.hideBackdrop()
        })
    }
    hideBackdrop() {
...
saved && radios.forEach(e => e.value === saved && (e.checked = !0, e.closest(".thememode-dropdown .dropdown-item").classList.add("active"))), radios.forEach(e => e.addEventListener("change", () => {
    items.forEach(e => e.classList.remove("active")), e.checked && (e.closest(".thememode-dropdown .dropdown-item").classList.add("active"), sessionStorage.setItem("theme", e.value))
}));
class Plugins {
    init() {
...
class I18nManager {
    constructor({
        defaultLang: e = "en",
        langPath: t = "backend/assets/data/translations/",
        ...
        this.selectedLanguage = sessionStorage.getItem("__UBOLD_LANG__") || e, this.langPath = t, this.langImageSelector = a, this.langCodeSelector = i, this.translationKeySelector = o, this.translationKeyAttribute = s, this.languageSelector = r, this.selectedLanguageImage = document.querySelector(this.langImageSelector), this.selectedLanguageCode = document.querySelector(this.langCodeSelector), this.languageButtons = document.querySelectorAll(this.languageSelector)
    }
    async init() {
    ...
    setLanguage(e) {
        this.selectedLanguage = e, sessionStorage.setItem("__UBOLD_LANG__", e), this.applyTranslations(), this.updateSelectedImage(), this.updateSelectedCode()
    }
    updateSelectedImage() {
        var e = document.querySelector(`[data-translator-lang="${this.selectedLanguage}"] [data-translator-image]`);
        e && this.selectedLanguageImage && (this.selectedLanguageImage.src = e.src), e && (document.querySelectorAll(".dropdown-item.active").forEach(e => {
...
class CustomApexChart {
    constructor({
        ...
        if (e) {
            this.selector = e, this.series = t, this.getOptions = a, this.colors = i, this.selector instanceof HTMLElement ? this.element = this.selector : this.element = document.querySelector(this.selector), this.chart = null;
            try {
    ...
    injectDynamicColors(e, a) {
        var t;
        return "boxplot" === e.chart?.type?.toLowerCase() && (e.plotOptions = e.plotOptions || {}, e.plotOptions.boxPlot = e.plotOptions.boxPlot || {}, e.plotOptions.boxPlot.colors = e.plotOptions.boxPlot.colors || {}, e.plotOptions.boxPlot.colors.upper = e.plotOptions.boxPlot.colors.upper || a[0], e.plotOptions.boxPlot.colors.lower = e.plotOptions.boxPlot.colors.lower || a[1]), Array.isArray(e.yaxis) && e.yaxis.forEach((e, t) => {
        ...
        }), e.markers && !e.markers.strokeColor && (e.markers.strokeColor = a), "gradient" === e.fill?.type && e.fill.gradient && (e.fill.gradient.gradientToColors = e.fill.gradient.gradientToColors || a), e.plotOptions?.treemap?.colorScale?.ranges && (0 < (t = e.plotOptions.treemap.colorScale.ranges).length && !t[0].color && (t[0].color = a[0]), 1 < t.length) && !t[1].color && (t[1].color = a[1]), e
    }
    static rerenderAll() {
...
class CustomChartJs {
    ...
    constructor({
        ...
        if (e) {
            this.selector = e, this.getOptions = "function" == typeof t ? t : () => t, this.element = null, this.chart = null;
            try {
    ...
    render() {
        try {
            var e, t, a, i;
            this.element = this.selector instanceof HTMLElement ? this.selector : document.querySelector(this.selector), this.element ? (this.chart && this.chart.destroy(), {
                type: e,
                data: t,
                options: a,
                plugins: i
            } = this.getOptions(), this.chart = new Chart(this.element, {
                type: e || "bar",
                data: t,
                options: {
