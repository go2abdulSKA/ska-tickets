                                    ...
                                    <div class="pt-0">
                                        ...
                                        @csrf
                                            ...
                                            <div class="mb-3 form-group">
                                                ...
                                                <input id="name" type="text" name="name" required="required" autofocus="autofocus" autocomplete="name" class="form-control" placeholder="Enter your Username">
                                            </div>

                                            <div class="mb-3 form-group">
                                                <label for="emailaddress" class="form-label">Email address</label>
                                                <input class="form-control" id="email" type="email" name="email" required="required" autocomplete="username" placeholder="Enter your email">
                                            </div>

                                            <div class="mb-3 form-group">
                                                <label for="password" class="form-label">Password</label>
                                                <input class="form-control" id="password" type="password" name="password" required="required" autocomplete="new-password" placeholder="Enter your password">
                                            </div>

                                            <div class="mb-3 form-group">
                                                <label for="password_confirmation" class="form-label">Confirm Password</label>
                                                <input class="form-control" id="password_confirmation" type="password" name="password_confirmation" required="required" autocomplete="new-password" placeholder="Enter your password">
                                            </div>
                                        ...
                                        {{-- <div class="row">
                                            <div class="col-12">
                                                <a class="mb-3 border btn text-dark fw-normal d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="col-12">
                                                <a class="mb-3 btn btn-primary fw-normal d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-xl-7">
                        <div class="p-4 account-page-bg p-md-5">
                            <div class="text-center">
                                <h3 class="mb-3 text-dark pera-title">Register - {{ config('app.name') }} </h3>
